...
class Config(object):
    def __init__(self,):
        ...
        # 2. anno
        # 3. cont
        self.cont_project = "Contrast_covid_reimp"
        self.anno_project = "Anno_covid_reimp"
        self.pre_project = "Pretrain_covid_reimp"


        # Define the data path.
        self.data_filepath1 = f"../new_covid_healthy.h5ad"
        self.data_filepath2 = f"../new_covid_plus.h5ad"

        # Define the output path
        self.output_path = "../example/output/new_covidv2/"
        ...
        self.clusters_true1 = np.load("../clusters_true1.npy")
        self.clusters_true2 = np.load("../clusters_true2.npy")
        self.expression_integrated = AnnDataset(self.x)
        # print(expression_integrated)
        
        self.adata1.obs['Cell_type_annotation_level2'] = self.clusters_true1
        self.adata2.obs['Cell_type_annotation_level2'] = self.clusters_true2
        #print(self.adata1.obs['Cell_type_annotation_level2'])
