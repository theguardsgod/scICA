...
class Train(Config):
    ...
    def run(self):
        ...
        for iteration in range(1, self.num_iteration+1):
            ...
            model_annocluster.embeddings_1 = nn.Parameter(centroids_torch_project1, requires_grad=True)
            model_annocluster.embeddings_2 = nn.Parameter(centroids_torch_project2, requires_grad=True)
