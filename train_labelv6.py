...
import gc
import itertools
from config_labelv6 import Config
import torch
import scanpy as sc
import pandas as pd
...
from unifan.annoclusterV6 import AnnoCluster
...
from unifan.trainerv6 import Trainer
    ...
    def run(self):
        ...
        for iteration in range(1, self.num_iteration+1):
            ...
            trainer = Trainer(dataset=Contr_expression, model=model_annocluster, learning_rate=self.alpha,
                            ...
                            save_infer=True, output_folder=self.annocluster_ZINB_folder, num_workers=0, 
                            contrastive_pair_1=pair_1, contrastive_pair_2=pair_2, use_cuda=self.use_cuda, iteration = iteration)
